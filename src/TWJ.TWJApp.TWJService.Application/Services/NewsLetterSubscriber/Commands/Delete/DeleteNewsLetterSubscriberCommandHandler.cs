...
{
    public class DeleteNewsLetterSubscriberCommandHandler : IRequestHandler<DeleteNewsLetterSubscriberCommand, Unit>
    {
        private readonly ITWJAppDbContext _context;
        private readonly IGlobalHelperService _globalHelper;
        private readonly string currentClassName = "";

        public DeleteNewsLetterSubscriberCommandHandler(ITWJAppDbContext context, IGlobalHelperService globalHelper)
        {
        ...
        public async Task<Unit> Handle(DeleteNewsLetterSubscriberCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                _context.NewsLetterSubscribers.Remove(data);
