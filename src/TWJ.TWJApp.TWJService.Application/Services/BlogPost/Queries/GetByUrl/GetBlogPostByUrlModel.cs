...
{
    public class GetBlogPostByUrlModel : IProfile
    {
        ...
        {
            profileMapper.Build<TWJ.TWJApp.TWJService.Domain.Entities.BlogPost, GetBlogPostByUrlModel>(
                (src, options) =>
                {
                    return new GetBlogPostByUrlModel
                    {
                        Id = src.Id,
                        Title = src.Title,
                        UserId = src.UserId,
