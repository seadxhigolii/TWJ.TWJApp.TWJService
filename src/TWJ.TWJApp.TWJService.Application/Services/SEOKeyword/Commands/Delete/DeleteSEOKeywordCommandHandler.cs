...
{
    public class DeleteSEOKeywordCommandHandler : IRequestHandler<DeleteSEOKeywordCommand, Unit>
    {
        private readonly ITWJAppDbContext _context;
        private readonly IGlobalHelperService _globalHelper;
        private readonly string currentClassName = "";

        public DeleteSEOKeywordCommandHandler(ITWJAppDbContext context, IGlobalHelperService globalHelper)
        {
        ...
        public async Task<Unit> Handle(DeleteSEOKeywordCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                _context.SEOKeywords.Remove(data);
